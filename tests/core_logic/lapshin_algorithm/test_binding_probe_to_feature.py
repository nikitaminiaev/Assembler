...
class TestBindingProbeToFeature(TestCase):
    ...
    def test_feature_in_aria(self) -> None:
        ...
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((9, 9), figure))
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((7, 9), figure))
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((9, 9), figure))
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((10, 10), figure))
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((10, 11), figure))
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((11, 10), figure))
        self.assertTrue(self.BindingProbeToFeature.feature_in_aria((11, 11), figure))

        self.assertFalse(self.BindingProbeToFeature.feature_in_aria((2,     1), figure))
        self.assertFalse(self.BindingProbeToFeature.feature_in_aria((20,   10), figure))
        self.assertFalse(self.BindingProbeToFeature.feature_in_aria((200, 191), figure))
        self.assertFalse(self.BindingProbeToFeature.feature_in_aria((6,     8), figure))
