...
В директории tests/stub_microcontroller лежит код для програмной эмуляции работы реального МК.  
Для его работы нужно скопировать файл cred.py из esp8266 в tests/stub_microcontroller.
...
Для подключения тестовой заклушки для МК:
    
    python tests/stub_microcontroller/main.py 
## Roadmap
Возможные будущие улучшения:
- сделать тестовую заглушку микроконтроллера, для функциональных тестов.
